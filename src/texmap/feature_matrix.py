...
def export_feature_matrix(config: TexMapConfig, paths: dict[str, Path]) -> list[Path]:
    ...
    feature_path = paths["feature_matrix"] / "features.csv"
    label_path = paths["feature_matrix"] / "labels.csv"
    split_path = paths["feature_matrix"] / "splits.csv"
    manifest_path = paths["feature_matrix"] / "manifest.json"
